function Invoke-ProxmoxApiPUT {
    ...
    try {
        Invoke-RestMethod -Uri $apiUrl -Headers $headers -Method Put -Body $bodyJson -ContentType "application/json" -SkipCertificateCheck -SkipHeaderValidation
    } catch {
